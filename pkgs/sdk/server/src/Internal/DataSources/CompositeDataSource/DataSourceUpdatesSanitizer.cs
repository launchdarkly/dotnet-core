...
namespace LaunchDarkly.Sdk.Server.Internal.DataSources
{
    ...
    /// <item><description>Map underlying DataSourceState.Closed to interrupted.</description></item>
    ...
    internal sealed class DataSourceUpdatesSanitizer : IDataSourceUpdates
    {
        ...
        public void UpdateStatus(DataSourceState newState, DataSourceStatus.ErrorInfo? newError)
        {
            ...
            // Map any future Closed state to Interrupted
            if (sanitized == DataSourceState.Shutdown)
            {
